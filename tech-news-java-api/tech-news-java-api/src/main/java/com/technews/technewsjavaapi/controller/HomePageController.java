...
public class HomePageController {
    ...
    @GetMapping("/")
        ...
        @GetMapping("/dashboard")
                public String dashboardPageSetup(Model  model, HttpServletRequest) throws Exception {
        ...
        @GetMapping("/dashboardEmptyTitleAndLink")
                public String dashboardEmptyTitleAndLink (Model model, HttpServletRequest request) throws Exception {
            setupDashboardPage(model, request);
